      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="md:hidden flex justify-between items-center w-full">
            ...
            {/* Logo - Center */}
            <Link to="/" className="flex items-center">
              <img src="/logo.png" alt="Sharp Lab by Owais" className="h-14 w-auto brightness-0" />
            </Link>
        ...
        {isOpen && (
          <div className="md:hidden pb-4">
            {/* Sharp Labs Heading for Mobile Menu */}
            <div className="text-center py-4 border-b border-gray-200 mb-4 bg-gradient-to-r from-gray-50 to-gray-100">
              <Link to="/" onClick={() => setIsOpen(false)}>
                <h1 className="text-2xl font-extrabold text-gray-800 uppercase tracking-wide">
                  Sharp Lab by Owais
                </h1>
                <p className="text-xs text-gray-600 mt-1 uppercase tracking-widest">Premium Knives</p>
              </Link>
            </div>
